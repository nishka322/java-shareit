...
public class ItemServiceImpl implements ItemService {
    ...
    public ItemServiceImpl(@Qualifier("inMemoryItemRepository") ItemRepository itemRepository, UserService userService) {
    ...
    public ItemDto createItem(long userId, ItemDto itemDto) {
        ...
        Item item = itemRepository.createItem(user, ItemMapper.mapToItem(itemDto, user));
    ...
    public ItemDto editItem(long userId, ItemDto itemDto, long itemId) {
        ...
        if (oldItem.getOwner() == null || oldItem.getOwner().getId() != userId) {
